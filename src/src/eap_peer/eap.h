...
struct eapol_callbacks {
	...
	/**
	 * This is useful for tunneled METHODs. This variable indicates the list of existing EAP methods
	 **/
...
struct eap_config {
	...
	/**
	 * eap_method - available eap_methods
	 *
	 * This is only used by tunneled EAP methods. List of availabe EAP methods for phase 2.	 
	 */
